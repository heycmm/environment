...
mkdir -p $oracle_home/app/
chown -R oracle:oinstall $oracle_home/app/
chmod -R 775 $oracle_home/app/
echo "Step 7 : Successed~!"

echo
echo
echo "Step 8 : Config bashrc in /home/oracle/.bashrc for oracle..."

cat >> /home/oracle/.bashrc << EOF

export ORACLE_BASE=$oracle_home/app/oracle
